 ...
 * local://github.com/pmndrs/drei/blob/master/src/core/Environment.tsx
 */
class GroundProjectedSkybox extends Mesh {
	...
	constructor( texture, options = {} ) {
		...
		const fragmentShader = defines.join( '\n' ) + /* glsl */ `
				...
				// From: local://www.shadertoy.com/view/4tsBD7
				...
				// From: local://www.iquilezles.org/www/articles/intersectors/intersectors.htm
