...
/**
 * Dependencies
 *  - mmd-parser local://github.com/takahirox/mmd-parser
 *  - TGALoader
 *  - OutlineEffect
 *
 ...
 *
 * MMD official site
 *  - local://sites.google.com/view/evpvp/
 *
 * PMD, VMD format (in Japanese)
 *  - local://blog.goo.ne.jp/torisu_tetosuki/e/209ad341d3ece2b1b4df24abf619d6e4
 *
 * PMX format
 *  - local://gist.github.com/felixjones/f8a06bd48f9da9a4539f
 *
 * TODO
...
class GeometryBuilder {
	...
	build( data ) {
		...
		for ( let i = 0; i < data.metadata.constraintCount; i ++ ) {
			...
			// Refer to local://www20.atpages.jp/katwat/wp/?p=4135
		...
		for ( let i = 0; i < data.metadata.materialCount; i ++ ) {
			...
			if ( data.metadata.format === 'pmd' ) {
				...
				if ( material.textureIndex !== - 1 ) {
					...
					// ref: local://gist.github.com/felixjones/f8a06bd48f9da9a4539f#texture
...
class CubicBezierInterpolation extends Interpolant {
	...
	_calculate( x1, x2, y1, y2, x ) {
		...
		/*
			 * Cubic Bezier curves
			 *   local://en.wikipedia.org/wiki/B%C3%A9zier_curve#Cubic_B.C3.A9zier_curves
			 *
			 * B(t) = ( 1 - t ) ^ 3 * P0
			 *      + 3 * ( 1 - t ) ^ 2 * t * P1
			 *      + 3 * ( 1 - t ) * t^2 * P2
			 ...
			 *   local://d.hatena.ne.jp/edvakf/20111016/1318716097
			 *
			 *    x = ( 1 - t ) ^ 3 * x0
			 *      + 3 * ( 1 - t ) ^ 2 * t * x1
			 *      + 3 * ( 1 - t ) * t^2 * x2
			 ...
			 *   local://en.wikipedia.org/wiki/Bisection_method
			 ...
			 *    local://en.wikipedia.org/wiki/Newton%27s_method)
			 */
