...
class TiltLoader extends Loader {
	...
	parse( buffer ) {
		...
		// local://docs.google.com/document/d/11ZsHozYn9FnWG7y3s3WAyKIACfbfwb4PbaS8cZ_xjvo/edit#
	...
	'colors': {
		...
		'LinearToSrgb': `
			vec3 LinearToSrgb(vec3 color) {
				// Approximation local://chilliant.blogspot.com/2012/08/srgb-approximations-for-hlsl.html
