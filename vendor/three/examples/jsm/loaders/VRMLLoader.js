...
class VRMLLoader extends Loader {
	...
	parse( data, path ) {
		...
		function createTokens() {
			...
			// from local://gun.teipir.gr/VRML-amgem/spec/part1/concepts.html#SyntaxBasics
			...
			// from local://gun.teipir.gr/VRML-amgem/spec/part1/nodesRef.html
		...
		function buildElevationGridNode( node ) {
			...
			for ( let i = 0; i < xDimension - 1; i ++ ) {
				...
				for ( let j = 0; j < zDimension - 1; j ++ ) {
					...
					// from local://tecfa.unige.ch/guides/vrml/vrml97/spec/part1/nodesRef.html#ElevationGrid
