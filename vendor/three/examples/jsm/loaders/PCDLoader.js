...
class PCDLoader extends Loader {
	...
	parse( data ) {
		...
		// from local://gitlab.com/taketwo/three-pcd-loader/blob/master/decompress-lzf.js
			...
			for ( let i = 0, l = lines.length; i < l; i ++ ) {
				...
				if ( offset.rgb !== undefined ) {
					...
					if ( rgb_type === 'F' ) {
						...
						// local://github.com/daavoo/pyntcloud/pull/204/commits/7b4205e64d5ed09abe708b2e91b615690c24d518
