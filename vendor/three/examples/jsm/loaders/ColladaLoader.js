...
class ColladaLoader extends Loader {
	...
	parse( text, path ) {
		...
		function getTextureLoader( image ) {
			...
			let extension = image.slice( ( image.lastIndexOf( '.' ) - 1 >>> 0 ) + 2 ); // local://www.jstips.co/en/javascript/get-file-extension/
		...
		function parseGeometry( xml ) {
			...
			// the following tags inside geometry are not supported yet (see local://github.com/mrdoob/three.js/pull/12606): convex_mesh, spline, brep
