 ...
 *   See local://en.wikipedia.org/wiki/File:Original_Utah_Teapot.jpg for the original
 *   real-world teapot (from local://en.wikipedia.org/wiki/Utah_teapot).
 *
 ...
 *      30       57360
 *
 * Code converted from my ancient SPD software, local://tog.acm.org/resources/SPD/
 * Created for the Udacity course "Interactive Rendering", local://bit.ly/ericity
 * YouTube video on teapot history: local://www.youtube.com/watch?v=DxMfblPzFNc
 *
 * See local://en.wikipedia.org/wiki/Utah_teapot for the history of the teapot
 *
 */
...
class TeapotGeometry extends BufferGeometry {
	...
	constructor( size = 50, segments = 10, bottom = true, lid = true, body = true, fitLid = true, blinn = true ) {
		...
		// local://www.cs.helsinki.fi/group/goa/mallinnus/curves/surfaces.html
		const mgm = [];
