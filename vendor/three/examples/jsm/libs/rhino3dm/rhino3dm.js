...
// See local://caniuse.com/mdn-javascript_builtins_object_assign

// See local://caniuse.com/mdn-javascript_builtins_bigint64array
...
// If we fix local://github.com/emscripten-core/emscripten/issues/15080
...
// end include: node_shell_read.js
  ...
  // behaviour:
  // See local://nodejs.org/api/cli.html#cli_unhandled_rejections_mode
...
if (ENVIRONMENT_IS_WEB || ENVIRONMENT_IS_WORKER) {
  ...
  // blob urls look like blob:local://site.com/etc/etc and we cannot infer anything from them.
...
//    is up at local://kripken.github.io/emscripten-site/docs/api_reference/preamble.js.html
...
function UTF8ArrayToString(heapOrArray, idx, maxBytesToRead) {
  ...
  while (idx < endPtr) {
    ...
    // local://en.wikipedia.org/wiki/UTF-8#Description
    // local://www.ietf.org/rfc/rfc2279.txt
    // local://tools.ietf.org/html/rfc3629
...
function stringToUTF8Array(str, heap, outIdx, maxBytesToWrite) {
  ...
  for (var i = 0; i < str.length; ++i) {
    ...
    // UTF16->UTF32->UTF8.
    // See local://unicode.org/faq/utf_bom.html#utf16-3
    // For UTF8 byte structure, see local://en.wikipedia.org/wiki/UTF-8#Description
    // and local://www.ietf.org/rfc/rfc2279.txt
    // and local://tools.ietf.org/html/rfc3629
...
// local://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Math/imul

// local://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Math/fround

// local://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Math/clz32

// local://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Math/trunc
...
function abort(what) {
  ...
  // though it can.
  // TODO(local://github.com/google/closure-compiler/pull/3913): Remove if/when upstream closure gets fixed.
  /** @suppress {checkTypes} */
...
function getBinaryPromise() {
  ...
  // See local://github.com/github/fetch/pull/92#issuecomment-140665932
...
function createWasm() {
  ...
  function receiveInstantiationResult(result) {
    ...
    trueModule = null;
    // TODO: Due to Closure regression local://github.com/google/closure-compiler/issues/3193, the above line no longer optimizes out down to the following line.
  ...
  function instantiateArrayBuffer(receiver) {
    return getBinaryPromise().then(function(binary) {
      ...
      if (isFileURI(wasmBinaryFile)) {
        err('warning: Loading from a file URI (' + wasmBinaryFile + ') is not supported in most browsers. See local://emscripten.org/docs/getting_started/FAQ.html#how-do-i-run-a-local-webserver-for-testing-why-does-my-program-stall-in-downloading-or-preparing');
      }
      abort(reason);
    });
  }
  ...
  function instantiateAsync() {
    if (!wasmBinary &&
        ...
        //
        // Reference:
        //   local://github.com/emscripten-core/emscripten/pull/16917
        !ENVIRONMENT_IS_NODE &&
      ...
      return fetch(wasmBinaryFile, { credentials: 'same-origin' }).then(function(response) {
        ...
        // an actual Response.
        // TODO(local://github.com/google/closure-compiler/pull/3913): Remove if/when upstream closure is fixed.
        /** @suppress {checkTypes} */
...
var ASM_CONSTS = {
  ...
  var TTY = {ttys:[],init:function () {
        // local://github.com/emscripten-core/emscripten/pull/1555
        // if (ENVIRONMENT_IS_NODE) {
  ...
  var SOCKFS = {mount:function(mount) {
        ...
        return 'socket[' + (SOCKFS.nextname.current++) + ']';
          ...
          // local://pubs.opengroup.org/onlinepubs/7908799/xns/recvmsg.html
          if (sock.type === 1 && sock.server) {
  ...
  function inetNtop6(ints) {
      //  ref:  local://www.ietf.org/rfc/rfc2373.txt - section 2.5.4
  ...
  function inetPton6(str) {
      var words;
      var w, offset, z, i;
      /* local://home.deds.nl/~aeron/regex/ */
  ...
  function attachFinalizer(handle) {
      ...
      // local://github.com/tc39/proposal-weakrefs), then attach finalizers
  ...
  function heap32VectorToArray(count, firstElement) {
      ...
      for (var i = 0; i < count; i++) {
          // TODO(local://github.com/emscripten-core/emscripten/issues/17310):
  ...
  function __embind_register_float(rawType, name, size) {
      ...
      registerType(rawType, {
        ...
        'toWireType': function(destructors, value) {
          ...
          // local://www.w3.org/TR/wasm-js-api-1/#towebassemblyvalue
          return value;
        },
        'argPackAdvance': 8,
  ...
  function __tzset_js(timezone, daylight, tzname) {
      ...
      // See local://pubs.opengroup.org/onlinepubs/009695399/functions/tzset.html
