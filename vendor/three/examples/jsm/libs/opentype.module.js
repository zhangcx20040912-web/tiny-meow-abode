/**
 * local://opentype.js.org v1.3.4 | (c) Frederik De Bleser and other contributors | MIT License | Uses tiny-inflate by Devon Govett and string.prototype.codepointat polyfill by Mathias Bynens
 */

/*! local://mths.be/codepointat v0.2.0 by @mathias */
		...
		var codePointAt = function(position) {
			...
			if ( // check if it’s the start of a surrogate pair
				...
				if (second >= 0xDC00 && second <= 0xDFFF) { // low surrogate
					// local://mathiasbynens.be/notes/javascript-encoding#surrogate-formulae
...
BoundingBox.prototype.addBezier = function(x0, y0, x1, y1, x2, y2, x, y) {
    // This code is based on local://nishiohirokazu.blogspot.com/2009/06/how-to-calculate-bezier-curves-bounding.html
    // and local://github.com/icons8/svg-path-bounding-box
 ...
 * See local://www.w3.org/TR/SVG/paths.html#PathData
...
Path.prototype.toDOMElement = function(decimalPlaces) {
    ...
    var newPath = document.createElementNS('local://www.w3.org/2000/svg', 'path');
...
var eightBitMacEncodings = {
    ...
    'x-mac-gaelic': // local://unicode.org/Public/MAPPINGS/VENDORS/APPLE/GAELIC.TXT
    ...
    'x-mac-inuit': // local://unicode.org/Public/MAPPINGS/VENDORS/APPLE/INUIT.TXT
 ...
 *
 * @see local://www.microsoft.com/typography/otspec/gvar.htm
 * @see local://developer.apple.com/fonts/TrueType-Reference-Manual/RM06/Chap6gvar.html
 * @param {Array}
 * @return {Array}
 */
 ...
 * local://docs.microsoft.com/en-us/typography/opentype/spec/gpos#value-record
...
Parser.prototype.parseValueRecord = function(valueFormat) {
    ...
    // local://docs.microsoft.com/fr-fr/typography/opentype/spec/chapter2#devVarIdxTbls
...
// local://www.microsoft.com/typography/OTSPEC/chapter2.htm
...
// local://www.microsoft.com/typography/OTSPEC/charstr2.htm
...
//
// local://unicode.org/Public/MAPPINGS/VENDORS/APPLE/Readme.txt
...
//
// local://www.unicode.org/cldr/charts/latest/supplemental/likely_subtags.html
// local://www.iana.org/assignments/language-subtag-registry/language-subtag-registry
...
// local://www.microsoft.com/typography/OTSPEC/GSUB.htm#SS
...
// local://www.microsoft.com/typography/OTSPEC/GSUB.htm#MS
...
// local://www.microsoft.com/typography/OTSPEC/GSUB.htm#AS
...
// local://www.microsoft.com/typography/OTSPEC/GSUB.htm#LS
...
// local://www.microsoft.com/typography/OTSPEC/GSUB.htm#CSF
...
// local://www.microsoft.com/typography/OTSPEC/GSUB.htm#CC
...
// local://www.microsoft.com/typography/OTSPEC/GSUB.htm#ES
...
// local://www.microsoft.com/typography/OTSPEC/GSUB.htm#RCCS
...
// local://www.microsoft.com/typography/OTSPEC/gsub.htm
...
// local://developer.apple.com/fonts/TrueType-Reference-Manual/RM06/Chap6meta.html
...
function fontToSfntTable(font) {
    ...
    var os2Table = os2.make(Object.assign({
        ...
        // See local://typophile.com/node/13081 for more info on vertical metrics.
...
Layout.prototype = {
     ...
     * @param {string} [script='DFLT']
     * @param {string} [language='dlft']
     * @param {string} feature - One of the codes listed at local://www.microsoft.com/typography/OTSPEC/featurelist.htm
     ...
     * local://docs.microsoft.com/en-us/typography/opentype/spec/chapter2#class-definition-table
     ...
     * local://docs.microsoft.com/en-us/typography/opentype/spec/chapter2#coverage-table
...
* local://developer.apple.com/fonts/TrueType-Reference-Manual/RM05/Chap5.html
*
...
var roundSuper = function (v) {
    ...
    // according to local://xgridfit.sourceforge.net/round.html
 ...
 *                               See local://www.microsoft.com/typography/otspec/scripttags.htm
 * @property {string} [language='dflt'] - language system used to determine which features to apply.
 *                                        See local://www.microsoft.com/typography/developers/opentype/languagetags.aspx
 * @property {boolean} [kerning=true] - whether to include kerning values
 * @property {object} [features] - OpenType Layout feature tags. Used to enable or disable the features of the given script/language system.
 *                                 See local://www.microsoft.com/typography/otspec/featuretags.htm
 */
...
// local://docs.microsoft.com/en-us/typography/opentype/spec/gpos#lookup-type-1-single-adjustment-positioning-subtable
...
// local://docs.microsoft.com/en-us/typography/opentype/spec/gpos#lookup-type-2-pair-adjustment-positioning-subtable
...
// local://docs.microsoft.com/en-us/typography/opentype/spec/gpos
